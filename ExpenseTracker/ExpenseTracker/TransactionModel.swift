...
extension Category {
    ...
    static let foodAndDrining = Category(id: 5, name: "Food & Dining", icon: .hamburger)
    ...
    static let publicTransportation = Category(id: 101, name: "Publict Transportation", icon: .bus, mainCategoryId: 1)
    ...
    static let financeCahrge = Category(id: 402, name: "Finance Charge", icon: .hand_holding_usd, mainCategoryId: 4)
